...
// هاذا كود الترحيب لما يخش شخص يقول انه خش ولما يطلع شخص يقول انه طلع شخص و يقول كم شخص باقي بالسيرفر
    ...
    client.on('guildMemberRemove', member => {
        ...
        .setColor('RED')
        .setFooter(`======= <الله يـلعنـك  ليـش  خـرجـت =======`, 'https://cdn.discordapp.com/attachments/397818254439219217/399292026782351381/shy.png')
...
client.on('message', message => {                      
    if(!message.channel.guild) return;
       ...
       message.channel.sendFile(`https://media.discordapp.net/attachments/444071272503050241/450979273206005780/colors.png`).then(msg => {
        ...
        msg.react('❤')  ,msg.react('🖤') ,msg.react('💛'),msg.react('💚'),msg.react('💜'),msg.react('💙'),msg.react('❌')
       ...
       .then(() => msg.react('❤')) , msg.react('🖤') , msg.react('💛') ,msg.react('💚') ,msg.react('💜')
     ...
     let activeFilter = (reaction, user) => reaction.emoji.name === '❤' && user.id === message.author.id;
       ...
       let active = msg.createReactionCollector(activeFilter, { time: 15000 });
                                    ...
                                    //red                    
                               active.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها احمر"))
...
//لون اسود
 ...
 let y1Filter = (reaction, user) => reaction.emoji.name === '🖤' && user.id === message.author.id;
       ...
       let y1 = msg.createReactionCollector(y1Filter, { time: 15000 });
                               ...
                               y1.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها اسود"))
...
let y2Filter = (reaction, user) => reaction.emoji.name === '💛' && user.id === message.author.id;
       ...
       let y2 = msg.createReactionCollector(y2Filter, { time: 15000 });
                               ...
                               y2.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها اصفر"))
...
let y3Filter = (reaction, user) => reaction.emoji.name === '💚' && user.id === message.author.id;
       ...
       let y3 = msg.createReactionCollector(y3Filter, { time: 15000 });
                               ...
                               y3.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها اخضر"))
...
let y4Filter = (reaction, user) => reaction.emoji.name === '💜' && user.id === message.author.id;
       ...
       let y4 = msg.createReactionCollector(y4Filter, { time: 15000 });
                               ...
                               y4.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها بنفسجي"))
...
let y5Filter = (reaction, user) => reaction.emoji.name === '💙' && user.id === message.author.id;
       ...
       let y5 = msg.createReactionCollector(y5Filter, { time: 15000 });
                               ...
                               y5.on("collect", r => {
                                   message.member.addRole(message.guild.roles.find("name", "اسم الرتبة الي يكون لونها ازرق"))
...
let y6Filter = (reaction, user) => reaction.emoji.name === '❌' && user.id === message.author.id;
       ...
       let y6 = msg.createReactionCollector(y6Filter, { time: 15000 });
                            ...
                            //اسم الرتبة الي هي واخده الرتبة تحطهم كلهم عشان يمسحهم 
...
client.on('message', msg => {
  if (msg.content === 'هلا') {
    msg.reply(':hand_splayed: **هلا فيك يا**');
  }
});
...
client.on('message', msg => {
  if (msg.content === 'تسلم') {
    msg.reply(':sparkling_heart: **تسلم يابعد قلبي  انت**');
  }
});
...
client.on('message', msg => {
  if (msg.content === 'باك') {
    msg.channel.send('**ولگ:hearts:̨̥̬ﻤـ:hearts:̨̥̬ ﻤـ:hearts:̨̥̬نور يِآإ**');
  }
});


client.on('message', msg => {
  if (msg.content === 'من صنعك') {
    msg.channel.send('**بايثور -PYTHOR **');
  }
});

client.on('message', msg => {
  if (msg.content === 'انا ليصنعتك') {
    msg.channel.send('** لا  مو  انت باث **');
  }
});
...
client.on('message', msg => {
  if (msg.content === 'برب') {
    msg.channel.send('**تـ:hearts:̨̥̬تـ:hearts:̨̥̬ ᵀᵀ أرجـ:hearts:̨̥̬ع لنآإ عن قـ:hearts:̨̥̬ريبـ:hearts:̨̥̬**');
  }
});
...
『.date / يعرض الوقت في الامارات و مكه المكرمه و مصر و التاريخ』
『.tag / اذا تبي  تزخرف وتبكر الكتابة زي دايموند』
『.discrim / يعرض مين عندو  نفس ايدي 』
『.restart / لإعادة  تشغيل البوت في  سيرفرك』
『.ser-create / لإنشاء سيرفر كامل』
『.share / ينشر سيرفرك  لمدة 7 دقاق من دون  رابط احذر لاتنشر روابط ان نشرت تاخذ بان من  قبل البوت احذر』
『.myid / امر يعطيك ايدي 』
『.gid / امر يعطيك ايدي سيرفر』
『.rep / لإعطاء ريب لشخص』
『.invites / لرؤيةالشخص كم جاب من عضو في سيرفر』
『الوان. / لرؤية الوان  بشكل  حميل  وجديد』
『.color / لإ ختيار  لون』
   ═══════════ஜ۩۞۩ஜ════════════
`,`
           __اوامر  عن البوت__ 
...
『.kick / كيك』
『.ban / بان』
『.bans / لرؤية عدد مبندين』
『.mute /ميوت』
『.unmute /فك الميوت』
『.mutechannel /قفل الشات』
『.unmutechannel /فتح الشات』
『.add.r / اضافه رتبه』
『.deletromes / لمسح كل رومات』
『.deletroles /للمسح كل رولات』
『.color 50 /انشاء 50 لون』
『.color 100/انشاء 100 لون』
『.color 140/انشاء 140 لوم』
『.ct /انشاء روم كتابي』4
『.cv /انشاء روم صوتي』
『.v3min / لإنشاء روم صوتي مؤقت لمدة 3 دقائق』
『.bc /برودكاست』
『.url /لإضافة اعضاء لسيرفر』
『.ser-create / لإنشاء سيرفر كامل』
 ═══════════ஜ۩۞۩ஜ════════════
 `,`         __ العاب__ 
...
client.on('message', message => {
    ...
    if (message.content === "F") {
        ...
        message.edit('**✱➼ FIN**')
        message.edit('**✱➼ FINE**')
        message.edit('**✱➼ RadThiek**')
        message.edit('**✱➼ RadThiek **')
        message.edit('**✱➼ RadThiek BOT**')
...
client.on('message', message => {
  ...
  message.channel.createInvite({
    ...
    const embed = new Discord.RichEmbed()
        .setColor("RANDOM")
        .setDescription("| :white_check_mark:  | :heart:  سيتم النشر تلقائي لمدة 7دقائق ")
...
**
---------------------
-[ ${message.guild.name}]  اسم السيرفر
---------------------
-سيتم النشر الأن
---------------------
-هذا نشر سيدوم لمدة 7 دقائق
---------------------
-نحن نتأسف  لأن البوت لاينشر بالساعات بل بالدقائق فقط
--------------------------------------------------------
**`)
...
const Love = [  "**احبك / عدد قطرات المـــطر والشجر وامواج البحر والنجوم الي تتزاحم مبهورة في جمال القمر**.",  "**ساعزفك وساجعلك لحنا تغني عليه جميع قصائد العشــق**.",  "**احبك موت... لاتسألني ما الدليل ارأيت رصاصه تسأل القتيل؟**.",  "**ربما يبيع الانسان شيئا قد شراه لاكن لا يبيع قلبا قد هواه**.",  "**و ما عجبي موت المحبين في الهوى ........... و لكن بقاء العاشقين عجيب**.",   "**حلفت / لاحشـــد جيوش الحب واحتلك مسكين ربي بلاك بعـــاشق ارهـــابي**.",   "**العيــن تعشق صورتك ... والقلب يجري فيه دمك وكل مااسمع صوتك ...شفايفي تقول احبك**.",   "**ياحظ المكان فيك..ياحظ من هم حواليك ...ياحظ الناس تشوفك ... وانا مشتاق اليك**.",   "**لو كنت دمعة داخل عيوني بغمض عليك وصدقي ما راح افتح...ولو كان الثمن عيوني**.",   "**سهل اموت عشانك لكن الصعب اعيش بدونك سهل احبك لكن صعب انساك**.",   "**أخشى ان انظر لعيناك وأنا فى شوق ولهيب لرؤياك**.",   "**أتمنى ان اكون دمعة تولد بعينيك واعيش على خديك واموت عند شفتيك**.",   "**أحياناً أرى الحياة لا تساوى إبتسامة لكن دائماً إبتسامتك هى كيانى**.",   "**من السهل أن ينسى الانسان نفسه .. لكن من الصعب ان ينسى نفساً سكنت نفسه !**.",   "**نفسى أكون نجمة سماك .. همسة شفاك .. شمعة مساك .. بس تبقى معايا وانا معاك**.",   "**أهنئ قلبى بحبك وصبر عينى فى بعدك وأقول إنك نور عينى يجعل روحى فدى قلبك**.", ]
 ...
 client.on('guildMemberAdd', member => {
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField(':loudspeaker: | نورتنا بوجوودك يعمري' , `Welcome to the server, ${member}`)
        .addField(':id: | user :', "**[" + `${member.id}` + "]**" )
                .addField('|➡رقم العضو الجديد',`${member.guild.memberCount}`)
...
client.on('message', message => {
  if(message.content == prefix + 'gid') {
    message.channel.send('**Your Guild 🆔 is**')
...
client.on('message', function(msg) {
    ...
    if(msg.content.startsWith (prefix  + 'server')) {
      ...
      .addField(':microphone:**__ رومات الصوتية__**',`[** __${msg.guild.channels.filter(m => m.type === 'voice').size}__ **]`,true)
      .addField(':crown:**__ الأونـر__**',`**${msg.guild.owner}**`,true)
      .addField(':id:**__ ايدي السيرفر__**',`**${msg.guild.id}**`,true)
      .addField(':date:**__ تم انشاء السيرفر__**',msg.guild.createdAt.toLocaleString())
 ...
 **
اتصل باصاحب البوت  اكتب | .contact
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('guildMemberAdd', member => {
    ...
    .setAuthor(member.user.username, member.user.avatarURL)
    .setThumbnail(member.user.avatarURL)
    .setTitle(`**عضو جديد**:hand_splayed: `)
...
client.on('message', message => {
    if (message.content.startsWith(".bans")) {
        ...
        .then(bans => message.channel.send(`${bans.size} **عرض الأشخاص المبندين في السيرفر** `))
  .catch(console.error);
}
});
